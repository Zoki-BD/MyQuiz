   ...
   return (
      <main className="min-h-screen flex items-center justify-center">
         ...
         <div className="p-3 py-5 md:p-8 bg-white shadow rounded-lg max-w-[800px] w-11/12 min-h-[300px]">
            <p className="text-right pb-2 text-gray-600">
               Number:{" "}
               <span>
                  ...
                  {answers.map((answer, index) => {
                     return (
                        <button
                           ...
                           key={index}
                           className="bg-orange-500 w-4/5 rounded-lg mx-auto text-white p-2 hover:bg-yellow-800"
            ...
            <div className="flex justify-center pt-4">
               <button
                  ...
                  className="py-2 px-7 text-medium flex rounded-lg text-white bg-slate-500 hover:bg-slate-800 "
               >
                  Next question
               </button>
            </div>
